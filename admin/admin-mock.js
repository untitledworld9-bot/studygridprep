  ...
  block.innerHTML = `
    ...
    <div id="qMatchWrap_${idx}" style="display:none;margin-bottom:12px;">
      ...
      <div style="overflow-x:auto;border-radius:8px;border:1px solid var(--border);">
        <table style="width:100%;border-collapse:collapse;min-width:320px;">
          ...
          <tbody id="qMatchBody_${idx}">
            ${[0,1,2,3].map(i=>`<tr>
              <td style="padding:4px 8px;border-bottom:1px solid var(--border);font-size:11px;color:var(--text-muted);text-align:center;">${i+1}</td>
              <td style="padding:3px;border-bottom:1px solid var(--border);"><input class="form-control q-left-${i}" type="text" placeholder="Left ${i+1}" style="font-size:12px;height:32px;"></td>
              <td style="padding:3px;border-bottom:1px solid var(--border);"><input class="form-control q-right-${i}" type="text" placeholder="Right ${i+1}" style="font-size:12px;height:32px;"></td>
            </tr>`).join('')}
          </tbody>
        </table>
      </div>
      ...
      <div style="margin-top:12px;">
        <div class="form-label" style="margin-bottom:8px;font-size:11px;">Answer Choices (A/B/C/D)</div>
        <div class="options-grid">
          <div class="opt-inp-wrap"><div class="opt-letter-badge">A</div><input class="opt-inp q-optA" type="text" placeholder="e.g. 1-p, 2-q, 3-r"></div>
          <div class="opt-inp-wrap"><div class="opt-letter-badge">B</div><input class="opt-inp q-optB" type="text" placeholder="Option B"></div>
          <div class="opt-inp-wrap"><div class="opt-letter-badge">C</div><input class="opt-inp q-optC" type="text" placeholder="Option C"></div>
          <div class="opt-inp-wrap"><div class="opt-letter-badge">D</div><input class="opt-inp q-optD" type="text" placeholder="Option D"></div>
        </div>
...
window.addMatchRow = function(idx) {
  ...
  tr.innerHTML = `
    <td style="padding:4px 8px;border:1px solid var(--border);font-size:11px;color:var(--text-muted);text-align:center;">${rowCount+1}</td>
    <td style="padding:4px;border:1px solid var(--border);"><input class="form-control q-left-${rowCount}" type="text" placeholder="Left ${rowCount+1}" style="font-size:12px;"></td>
    <td style="padding:4px;border:1px solid var(--border);"><input class="form-control q-right-${rowCount}" type="text" placeholder="Right ${rowCount+1}" style="font-size:12px;"></td>`;
