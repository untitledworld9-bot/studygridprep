...
// Also update game-over leaderboard when data loads
const _origRenderILB = renderInGameLeaderboard;
// Override to also populate the game-over copy
function renderInGameLeaderboard() {
  _origRenderILB?.call?.(this) || (() => {
    // fallback - run original logic
  })();
  ...
  el2.innerHTML = `
    ...
    <div id="inGameLeaderboard" style="margin:0;">
      <div class="ilb-header">
        <span class="ilb-title">🏆 LEADERBOARD</span>
        <span class="ilb-count">${_lbData.length} players</span>
      </div>
